...
void EditNetworkDlg::populateData(QString &line) {
   ...
   if (id == "N=") {
      networkLE->setText(lineData);
   } else if (id == "S=") {
      serverLE->setText(lineData);
   } else if (id == "p=") {
      portLE->setText(lineData);
   } else if (id == "I=") {
      nickLE->setText(lineData);
   } else if (id == "i=") {
      nick2LE->setText(lineData);
   } else if (id == "U=") {
      usernameLE->setText(lineData);
   } else if (id == "R=") {
      realNameLE->setText(lineData);
   } else if (id == "L=") {
      loginMethodCbo->setCurrentIndex(lineData.toInt());
   } else if (id == "P=") {
      passwordLE->setText(lineData);
   } else if (id == "J=") {
      joinChansLE->setText(lineData);
   } else if (id == "c=") {
      bool cBool;
