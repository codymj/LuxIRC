/********************************************************************************
** Form generated from reading UI file 'EditNetworkDlg.ui'
**
...
#ifndef UI_EDITNETWORKDLG_H
#define UI_EDITNETWORKDLG_H
...
public:
    ...
    void setupUi(QDialog *EditNetworkDlg)
    {
        if (EditNetworkDlg->objectName().isEmpty())
            EditNetworkDlg->setObjectName(QStringLiteral("EditNetworkDlg"));
        EditNetworkDlg->setWindowModality(Qt::ApplicationModal);
        EditNetworkDlg->setEnabled(true);
        EditNetworkDlg->resize(542, 254);
        EditNetworkDlg->setMinimumSize(QSize(542, 254));
        EditNetworkDlg->setMaximumSize(QSize(542, 254));
        EditNetworkDlg->setInputMethodHints(Qt::ImhNone);
        EditNetworkDlg->setModal(true);
        layoutWidget = new QWidget(EditNetworkDlg);
        ...
        layoutWidget1 = new QWidget(EditNetworkDlg);
        ...
        layoutWidget2 = new QWidget(EditNetworkDlg);
        ...
        layoutWidget3 = new QWidget(EditNetworkDlg);
        ...
        retranslateUi(EditNetworkDlg);
        QObject::connect(saveBtn, SIGNAL(clicked()), EditNetworkDlg, SLOT(accept()));
        QObject::connect(cancelBtn, SIGNAL(clicked()), EditNetworkDlg, SLOT(reject()));

        QMetaObject::connectSlotsByName(EditNetworkDlg);
    } // setupUi

    void retranslateUi(QDialog *EditNetworkDlg)
    {
        EditNetworkDlg->setWindowTitle(QApplication::translate("EditNetworkDlg", "Edit Network", 0));
        connectCkb->setText(QApplication::translate("EditNetworkDlg", "Connect at Start-Up", 0));
        sslCkb->setText(QApplication::translate("EditNetworkDlg", "Use SSL Encryption", 0));
        invalidCertCkb->setText(QApplication::translate("EditNetworkDlg", "Accept Invalid SSL Certificate", 0));
        globalInfoCkb->setText(QApplication::translate("EditNetworkDlg", "Use Global Information", 0));
        cancelBtn->setText(QApplication::translate("EditNetworkDlg", "&Cancel", 0));
        saveBtn->setText(QApplication::translate("EditNetworkDlg", "&Save", 0));
        label_9->setText(QApplication::translate("EditNetworkDlg", "Network:", 0));
        label->setText(QApplication::translate("EditNetworkDlg", "Server:", 0));
        label_2->setText(QApplication::translate("EditNetworkDlg", "Port:", 0));
        label_3->setText(QApplication::translate("EditNetworkDlg", "Nickname:", 0));
        label_4->setText(QApplication::translate("EditNetworkDlg", "Second Nick:", 0));
        label_5->setText(QApplication::translate("EditNetworkDlg", "Username:", 0));
        label_6->setText(QApplication::translate("EditNetworkDlg", "Real Name:", 0));
        label_7->setText(QApplication::translate("EditNetworkDlg", "Login Method:", 0));
        loginMethodCbo->clear();
        loginMethodCbo->insertItems(0, QStringList()
         << QApplication::translate("EditNetworkDlg", "Default", 0)
         << QApplication::translate("EditNetworkDlg", "Server Password (/SERVER <PASS>)", 0)
         << QApplication::translate("EditNetworkDlg", "NickServ (/msg NickServ Identify <PASS>)", 0)
        );
        label_8->setText(QApplication::translate("EditNetworkDlg", "Password:", 0));
        label_10->setText(QApplication::translate("EditNetworkDlg", "Channels:", 0));
        joinChansLE->setPlaceholderText(QApplication::translate("EditNetworkDlg", "#chan1,#chan2,#chan3", 0));
    } // retranslateUi

};

namespace Ui {
    class EditNetworkDlg: public Ui_EditNetworkDlg {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_EDITNETWORKDLG_H
